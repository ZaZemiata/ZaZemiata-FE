    ...
    return (
        <div className="flex flex-col items-center gap-6 my-6 w-[75rem] m-auto relative">
            ...
            {(isLoading || isPlaceholderData) && (
                <div role="status">
                <svg aria-hidden="true" className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-[#729c82]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
